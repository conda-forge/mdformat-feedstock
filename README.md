...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mdformat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12731&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mdformat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mdformat` can be installed with:

```
conda install mdformat
```

It is possible to list all of the versions of `mdformat` available on your platform with:
